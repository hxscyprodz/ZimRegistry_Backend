...
export const birthApplications = pgTable("birth_applications",{
    ...
    ...details,
    ...applications,
    mothersIdNumber: varchar("mothers_id_number", { length: 15 }).notNull(),
    fathersIdNumber: varchar("fathers_id_number", { length: 15 }),
    hospitalRecordUri: varchar("hospital_record_uri", { length: 255 }).notNull(),
    motherIdUri: varchar("mother_id_uri", { length: 255 }).notNull(),
